...
const Beer = ({ alc: initialAlc, addToCart }) => {

    const [initial_alc, setinitialAlc] = useState(initialAlc.filter(alc=>alc.type === 'beer').slice());
                ...
                <div className="container">
                    <div className="top__bar">
                        <div className="beer__info">
                            <span className='title'>Beer</span> <span className="number__products">({initial_alc.length} Products)</span>
                        </div>
                        <div className="sort">
                    ...
                    <div className="alc__wrapper">
                        <div className="alc__body--wrapper">
                            <div className="filters">
                                <Filter filterTypes={filterTypes} filters={['Domestic Beer','Imported Beer']} header='Type' />
                            </div>
